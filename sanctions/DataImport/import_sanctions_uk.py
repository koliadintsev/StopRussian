...
from sanctions.DataModel.UK import sanction_UK, sanction_UK_individual, sanction_UK_name, sanction_UK_indicator, \
    sanction_UK_address
from sanctions.DataModel.UK import sanction_UK_Entity
